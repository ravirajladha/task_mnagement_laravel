                                        ...
                                        <tbody class="list form-check-all">
                                            ...
                                            $count = 0;
                                             if (count($managers) > 0) { 
                                                ...
                                                ?>
                                                <tr>
                                                    <td class="service_type" colspan="6">Total Managers: <?php echo count($managers); ?></td>
                                                </tr>
                                                <?php foreach ($managers as $manager) { ?>
                                                    <tr>
                                                        ...
                                                        <td class="service_type"><?php echo $manager->phone ?></td>
                                                        <td class="service_type"><?php echo $manager->post ?></td>
                                                        <td class="service_type"><?php echo $manager->joining_date ?></td>
                                                    </tr>
                                                <?php } ?>
                                            <?php } else { ?>
                                                <tr>
                                                    <td class="service_type" colspan="6">No managers in the database.</td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
