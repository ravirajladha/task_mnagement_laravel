<?php require APPROOT . '/views/inc_sr_managers/header.php'; ?>
                            ...
                            <div class="row g-4 align-items-center">
                                ...
                                <div class="col-sm-auto ms-auto">
                                    <div class="hstack gap-2">
                                        ...
                                        <button type="button" class="btn btn-success add-btn" data-bs-toggle="modal" id="create-btn" data-bs-target="#showModal"><i class="ri-add-line align-bottom me-1"></i>Add Manager</button>
                                        <span class="dropdown">
                                ...
                                <div class="table-responsive table-card">
                                    <table class="table align-middle" id="customerTable">
                                        ...
                                        <tbody class="list form-check-all">
                                            <tr>
                                            <?php foreach ($data['get_all_managers'] as $manager) { ?>
                                                <td class="service_type"><?php echo $manager->id ?></td>
                                                <td class="service_type"><?php echo $manager->name ?></td>
                                                <td class="service_type"><?php echo $manager->email ?></td>
                            ...
                            <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <form action="<?php echo URLROOT; ?>/sr_managers/add_manager" method="post">
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div>
                                                            ...
                                                            <input type="number" name="phone" id="phone-field" class="form-control" placeholder="Enter Phone Number" required />
                                                        </div>
                                                    </div>
                                                    <!--end col-->
...
<?php require APPROOT . '/views/inc_sr_managers/footer.php'; ?>